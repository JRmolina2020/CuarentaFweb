...
</p> </details> <details class="bg-white p-4 rounded-xl shadow"> <summary class="font-semibold cursor-pointer">¿Puedo cambiar de plan en cualquier momento?</summary> <p class="mt-2 text-gray-700">
...
</p> </details> <details class="bg-white p-4 rounded-xl shadow"> <summary class="font-semibold cursor-pointer">
¿Qué formas de pago aceptan?</summary> <p class="mt-2 text-gray-700">
...
¿El software funciona en celular y computador?</summary> <p class="mt-2 text-gray-700">
Sí, es 100% compatible con celulares, tabletas y computadores. Solo
        necesitas conexión a internet.
</p> </details> <details class="bg-white p-4 rounded-xl shadow"> <summary class="font-semibold cursor-pointer">
¿La suscripción incluye soporte técnico?</summary> <p class="mt-2 text-gray-700">
¡Sí! Te acompañamos por WhatsApp o llamada en caso de dudas, errores o
        configuración. Nunca estás solo.
</p> </details> <details class="bg-white p-4 rounded-xl shadow"> <summary class="font-semibold cursor-pointer">
¿Es obligatorio emitir facturas electrónicas?</summary> <p class="mt-2 text-gray-700">
...
¿El software sirve para cualquier tipo de negocio?</summary> <p class="mt-2 text-gray-700">
...
const $$Divtext = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="w-full bg-[#ffff]/50 text-black py-20 px-6 flex items-center justify-center"> <div class="max-w-xl text-center"> <!-- Logo como imagen --> <div class="flex justify-center mb-6"> <img src="/img/favico.jpg" alt="Logo 40F" class="w-12 h-auto"> </div> <!-- Texto --> <p class="text-lg mb-3">${subtitle}</p> <h2 class="text-2xl font-bold mb-6">${title}</h2> <!-- Botón WhatsApp --> <a href="https://wa.me/573003146150" target="_blank" class="inline-block bg-[#55b290] text-white px-6 py-3 rounded-full font-medium hover:bg-[#3e9c79] transition">
Empezar
</a> </div> </section>`;
