...
Elige el plan según la cantidad de documentos<br> <span class="font-semibold text-[#55b290]">✔ Incluye todas las funciones del plan POS Básic</span> </p> <div class="overflow-x-auto"> <table class="w-full text-sm text-left text-gray-600"> <thead class="text-xs uppercase bg-gray-100 text-gray-700"> <tr> <th class="px-4 py-3">Seleccionar</th> <th class="px-4 py-3">Plan</th> <th class="px-4 py-3">Documentos</th> <th class="px-4 py-3">Precio</th> </tr> </thead> <tbody> <tr class="border-b"> <td class="px-4 py-2 text-center"> <input type="radio" name="planSelect" value="Emprendedor"> </td> <td class="px-4 py-2">Emprendedor</td> <td class="px-4 py-2">Hasta 150</td> <td class="px-4 py-2">$409.000</td> </tr> <tr class="border-b"> <td class="px-4 py-2 text-center"> <input type="radio" name="planSelect" value="Negocio"> </td> <td class="px-4 py-2">Negocio</td> <td class="px-4 py-2">Hasta 400</td> <td class="px-4 py-2">$430.000</td> </tr> <tr class="border-b"> <td class="px-4 py-2 text-center"> <input type="radio" name="planSelect" value="Empresa"> </td> <td class="px-4 py-2">Empresa</td> <td class="px-4 py-2">Hasta 1.600</td> <td class="px-4 py-2">$460.000</td> </tr> <tr class="border-b"> <td class="px-4 py-2 text-center"> <input type="radio" name="planSelect" value="Empresarial"> </td> <td class="px-4 py-2">Empresarial</td> <td class="px-4 py-2">Hasta 2.500</td> <td class="px-4 py-2">$500.000</td> </tr> <tr class="border-b"> <td class="px-4 py-2 text-center"> <input type="radio" name="planSelect" value="Avanzado"> </td> <td class="px-4 py-2">Avanzado</td> <td class="px-4 py-2">Hasta 5.000</td> <td class="px-4 py-2">$530.000</td> </tr> <tr class="border-b"> <td class="px-4 py-2 text-center"> <input type="radio" name="planSelect" value="Premium"> </td> <td class="px-4 py-2">Premium</td> <td class="px-4 py-2">Hasta 10.000</td> <td class="px-4 py-2">$630.000</td> </tr> <tr class="border-b"> <td class="px-4 py-2 text-center"> <input type="radio" name="planSelect" value="Ultra"> </td> <td class="px-4 py-2">Ultra</td> <td class="px-4 py-2">Hasta 15.000</td> <td class="px-4 py-2">$680.000</td> </tr> </tbody> </table> </div> <div class="text-center mt-6"> <button id="btnSeleccionarPlan" disabled class="bg-gray-300 text-gray-700 px-6 py-2 rounded-full font-semibold cursor-not-allowed">
Seleccionar
</button> </div> </div> </section> ${renderScript($$result, "C:/Users/USUARIO/Desktop/facturacion-astro/src/components/Pricing.astro?astro&type=script&index=0&lang.ts")}`;
...
</p> <p class="font-bold text-[#343439]">BellezaTC - Cartagena</p> <p class="text-sm text-gray-500">Centro de Belleza</p> </div> </div> </section>`;
